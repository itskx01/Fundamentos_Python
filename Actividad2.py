#PARTE 1 : Nombrar la variables y agregar la informacion que va a llevar cada variable
print("\n")
...
#PARTE 2 : Imprimir las variables, redondeando los valores
print("\n")
...
#PARTE 3: Se esta poniemdo la condicion de aprobado y no aprobado con el if y else
if aprobado:
